    ...
    export class DeviceDriverKeyboard extends DeviceDriver {
        ...
        public krnKbdDispatchKeyPress(params) {
            ...
            // check for up and down arrow, backspace, or tab
                ...
                else if(keyCode == 9) chr = String.fromCharCode(9);
                _KernelInputQueue.enqueue(chr);
            ...
            // did this for ls -a and copliot gave me the correct char code so that was cool
                ...
                if(isShifted === true) chr = String.fromCharCode(95);
                else chr = String.fromCharCode(45);
                _KernelInputQueue.enqueue(chr);
            }
            ...
            // check for all dig, space, special chars, and enter
                ...
                if(isShifted === true){                        // !@#$$%^&*()
                    ...
                    else if(keyCode == 59) chr = String.fromCharCode(59);
                }
                else{
            ...
            // check for more special char
                ...
                if(isShifted === true){
                    ...
                    else if (keyCode === 189) chr = String.fromCharCode(95);

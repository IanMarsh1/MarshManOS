...
//
const APP_NAME: string    = "MarshManOS";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "2112";   // What did you expect?

const CPU_CLOCK_INTERVAL: number = 20;   // This is in ms (milliseconds) so 1000 = 1 second.
